...
public class Bomb {
    ...
    public Bomb(final World world,final float x , final float y,final HashMap<Body,String> bodies){
        this.yk = yk;
        this.mx = mx;
    ...
    private Body initPhysicsBody(World world,float x , float y){
        ...
        bodyDef.position = new Vec2( (x), y+1f);
    ...
    public int getX(){
        return (int)(body.getPosition().x / Play1.M_PER_PIXEL) ;
    }
