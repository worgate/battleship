...
public class Play3 extends Screen{
    ...
    //int countEnemy = 0;
    int MaxEnemy = 5;
    int[]  timeline = {50,200,300,100,400,450,500,650,700,750,770,790,810};
    int[] positionY = {250,220,180,260,300,240,170,320,220,250,270,290,310};
    private  ArrayList<Bullet> bullets = new ArrayList<Bullet>();
    int jetHp = 100;

    public Play3(final ScreenStack ss, final Profile profile) {
